  ...
  return (
        ...
        <section className="hero-slider-section relative py-8 w-screen flex flex-col items-center" style={{ marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%),z-index: 1' }}>
          <div className="py-12">
            <div className="max-w-7xl mx-auto px-4 text-center text-white">
              Hero Section - {slides.length} slides
            </div>
          </div>
          
          {/* Controles externos del slider */}
          {sliderControls && slides.length > 1 && (
            <div className="relative w-[90%] mt-[26px]">
              {/* Flechas en los extremos */}
              <div className="flex justify-between items-center">
                {/* Flecha Izquierda - Al inicio */}
                <button
                  onClick={sliderControls.handlePrev}
                  className="group flex items-center justify-center w-10 h-10 bg-black/20 backdrop-blur-sm border border-white/20 rounded-full hover:bg-white/10 transition-all duration-300"
                  ...
                  {slides.map((_, index) => (
                    <button
                      ...
                      className={`w-2 h-2 rounded-full transition-all duration-300 ${
                        index === sliderControls.currentIndex
    ...
    <div className="shape1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-4 lg:max-w-lg">
              <p className="text-[20px] text-white leading-relaxed text-center lg:text-left">
      ...
      <div className="space-y-0">
        {/* Brands Slider */}
        <section className="relative brands-slider-section">
          <div className="py-12">
            <div className="max-w-7xl mx-auto px-4 text-center text-white">
              Brands Section
            </div>
        ...
        {/* Services Section 
         <div className="services-section-wrapper relative z-[100]">
             {/* Brands Slider  <ServicesSection /> 
         </div>
         */}
      ...
      <div className="space-y-0 relative z-[100]" style={{ backgroundColor: '#000' }}>
      {/* Featured Products */}
      <section className="featured-products-section relative z-[100] py-16" >
        <div className="container mx-auto px-4">
          <div className="py-12">
            <div className="max-w-7xl mx-auto px-4 text-center text-white">
              Featured Products Section - {featuredProducts.length} products
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative">
              ...
              <div className="absolute -left-8 -top-8 w-32 h-32 bg-lime-400 rounded-full opacity-80"></div>
                  ...
                  <div className="aspect-video bg-gray-200 rounded-2xl overflow-hidden relative">
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-gray-300 font-medium">Video del Proceso</p>
                      </div>
                    </div>
                  </div>
                </div>
